<script context="module">
  /**
   * A simple utility for conditionally joining classNames together. You might be more familiar
   * with the npm package named 'classnames'; it's the same thing, just copied here from Woodshed version.
   *
   * Usage examples
   * ```js
